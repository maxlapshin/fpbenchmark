...
plot_colors <- c("blue","red","forestgreen","black","orange","green","darkblue")
...
title(main="Cowboy/Warp/Ocsigen/NodeJS/Vibe/GoHttp", col.main="red", font.main=1)
...
legend("topleft", c("ngnix","cowboy","warp","ocsigen","nodejs","vibe","gohttp"), cex=1, col=plot_colors, pch=20:25, lty=1:7);
